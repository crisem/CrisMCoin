...
uint256 hashGenesisBlock("0xecd479b40cb89248cb7b59f94c9892f5738b7311e2d540ad631b9d0c4c802519");
...
const string strMessageMagic = "CrisMCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // CrisMCoin: 0.35 days
static const int64 nTargetSpacing = 15; // CrisMCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal CrisMCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CrisMCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// Genesis block:
	/*
	block.nTime = 1512467905 
	block.nNonce = 2086383649 
	block.GetHash = ecd479b40cb89248cb7b59f94c9892f5738b7311e2d540ad631b9d0c4c802519
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086383649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "First Coin Project";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x4afc0aa1b56f616b70905abb08bd99302b021d9e23f0f4adda5ee6ba1cb0403a"));
